  ...
  return (
    <main className="min-lg:w-3/4">
      <section className="flex justify-between gap-4 max-sm:flex-col items-center">
        <Image src={user.imageUrl} alt="Profile" width={110} height={110} className="max-sm:w-1/2" />
        <div className="flex gap-4 items-center"><div className="flex flex-col gap-2">
        ...
        <div className="flex gap-4">
          <div className="border border-black rounded-lg p-3 gap-2 flex flex-col h-fit">
            ...
            <div className="p-2">Lessons completed</div>
          </div>
          ...
          <div className="border border-black rounded-lg p-3 gap-2 flex flex-col h-fit">
            ...
            <div className="p-2">Companions created</div>
          </div>
        </div>
      </section>

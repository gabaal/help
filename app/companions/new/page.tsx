  ...
  return (
    <main className="min-lg:w-1/3 min-md:w-2/3 items-center justify-center">
      {canCreateCompanion ? (<article className="w-full gap-4 flex flex-col">
        ...
        <Image src='/images/limit.svg' alt='Limit Reached' width={3600} height={230} />
        <div className="cta-badge">Upgrade your plan </div>
        <h1 className="">You&apos;ve reached your limit</h1>
        <p className="">You&apos;ve reached your companion limit. Upgrade to create more companions and premium features.</p>
